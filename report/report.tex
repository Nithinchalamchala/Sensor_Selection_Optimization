...
\begin{titlepage}
  ...
  for Smart Systems}\\[0.6cm]

  {\large\itshape A Binary Combinatorial Optimization Study\\
  using Genetic Algorithm, Simulated Annealing,\\
  Binary Particle Swarm Optimization, and a Hybrid SAGA}\\[1.0cm]
